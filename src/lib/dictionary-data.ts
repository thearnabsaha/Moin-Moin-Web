...
export const COMMON_GERMAN_DICTIONARY: Record<string, DictionaryEntry> = {
  // Core Verbs from user reports & Goethe A1/A2 Curriculum
  'anfangen': {
    meaning: 'to start, to begin',
    partOfSpeech: 'verb',
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Der Deutschkurs fängt um neun Uhr an.',
    verbType: 'irregular',
    auxiliaryType: 'haben',
    presentForm: 'fängt an',
    simplePast: 'fing an',
    perfectForm: 'hat angefangen',
    conjugation: {
      ich: 'fange an',
      du: 'fängst an',
      er: 'fängt an',
  ...
  'fangen': {
    ...
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Der Torwart fängt den Ball sicher mit beiden Händen.',
    verbType: 'irregular',
    auxiliaryType: 'haben',
    presentForm: 'fängt',
    simplePast: 'fing',
    perfectForm: 'hat gefangen',
    conjugation: {
      ich: 'fange',
      du: 'fängst',
      er: 'fängt',
  ...
  'halten': {
    ...
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Der Bus hält direkt vor dem Bahnhof.',
    verbType: 'irregular',
    auxiliaryType: 'haben',
    presentForm: 'hält',
    simplePast: 'hielt',
    perfectForm: 'hat gehalten',
    conjugation: {
      ich: 'halte',
      du: 'hältst',
      er: 'hält',
  ...
  'tragen': {
    meaning: 'to wear, to carry',
    partOfSpeech: 'verb',
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Sie trägt heute eine sehr schöne warme Jacke.',
    verbType: 'irregular',
    auxiliaryType: 'haben',
    presentForm: 'trägt',
    simplePast: 'trug',
    perfectForm: 'hat getragen',
    conjugation: {
      ich: 'trage',
      du: 'trägst',
      er: 'trägt',
  ...
  'schlagen': {
    ...
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Sein Herz schlägt ruhig und gleichmäßig.',
    verbType: 'irregular',
    auxiliaryType: 'haben',
    presentForm: 'schlägt',
    simplePast: 'schlug',
    perfectForm: 'hat geschlagen',
    conjugation: {
      ich: 'schlage',
      du: 'schlägst',
      er: 'schlägt',
  ...
  'fallen': {
    ...
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Im Herbst fallen die bunten Blätter von den Bäumen.',
    verbType: 'irregular',
    auxiliaryType: 'sein',
    presentForm: 'fällt',
    simplePast: 'fiel',
    perfectForm: 'ist gefallen',
    conjugation: {
      ich: 'falle',
      du: 'fällst',
      er: 'fällt',
  ...
  'hassen': {
    ...
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Ich hasse es, wenn es den ganzen Tag regnet.',
    verbType: 'regular',
    auxiliaryType: 'haben',
    presentForm: 'hasst',
    simplePast: 'hasste',
    perfectForm: 'hat gehasst',
    conjugation: {
      ich: 'hasse',
      du: 'hasst',
      er: 'hasst',
  ...
  'erkennen': {
    ...
    gender: null,
    cefrLevel: 'A2',
    exampleSentence: 'Ich habe ihn an seiner Stimme sofort erkannt.',
    verbType: 'mixed',
    auxiliaryType: 'haben',
    presentForm: 'erkennt',
    simplePast: 'erkannte',
    perfectForm: 'hat erkannt',
    conjugation: {
      ich: 'erkenne',
      du: 'erkennst',
      er: 'erkennt',
  ...
  'bringen': {
    meaning: 'to bring, to take somewhere',
    partOfSpeech: 'verb',
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Bringst du mir bitte ein Glas Wasser mit?',
    verbType: 'mixed',
    auxiliaryType: 'haben',
    presentForm: 'bringt',
    simplePast: 'brachte',
    perfectForm: 'hat gebracht',
    conjugation: {
      ich: 'bringe',
      du: 'bringst',
      er: 'bringt',
  ...
  'denken': {
    ...
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Was denkst du über diese neue Idee?',
    verbType: 'mixed',
    auxiliaryType: 'haben',
    presentForm: 'denkt',
    simplePast: 'dachte',
    perfectForm: 'hat gedacht',
    conjugation: {
      ich: 'denke',
      du: 'denkst',
      er: 'denkt',
  ...
  'öffnen': {
    ...
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Können Sie bitte das Fenster im Zimmer öffnen?',
    verbType: 'regular',
    auxiliaryType: 'haben',
    presentForm: 'öffnet',
    simplePast: 'öffnete',
    perfectForm: 'hat geöffnet',
    conjugation: {
      ich: 'öffne',
      du: 'öffnest',
      er: 'öffnet',
  ...
  'schließen': {
    ...
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Das Geschäft schließt heute pünktlich um 20 Uhr.',
    verbType: 'irregular',
    auxiliaryType: 'haben',
    presentForm: 'schließt',
    simplePast: 'schloss',
    perfectForm: 'hat geschlossen',
    conjugation: {
      ich: 'schließe',
      du: 'schließt',
      er: 'schließt',
  ...
  'verlieren': {
    ...
    gender: null,
    cefrLevel: 'A2',
    exampleSentence: 'Ich verliere leider sehr oft meinen Hausschlüssel.',
    verbType: 'irregular',
    auxiliaryType: 'haben',
    presentForm: 'verliert',
    simplePast: 'verlor',
    perfectForm: 'hat verloren',
    conjugation: {
      ich: 'verliere',
      du: 'verlierst',
      er: 'verliert',
  ...
  'gewinnen': {
    ...
    gender: null,
    cefrLevel: 'A2',
    exampleSentence: 'Unsere Fußballmannschaft gewinnt heute das Spiel.',
    verbType: 'irregular',
    auxiliaryType: 'haben',
    presentForm: 'gewinnt',
    simplePast: 'gewann',
    perfectForm: 'hat gewonnen',
    conjugation: {
      ich: 'gewinne',
      du: 'gewinnst',
      er: 'gewinnt',
  ...
  'lieben': {
    ...
    gender: null,
    cefrLevel: 'A1',
    exampleSentence: 'Ich liebe meine Familie und meine Heimat.',
    verbType: 'regular',
    auxiliaryType: 'haben',
    presentForm: 'liebt',
    simplePast: 'liebte',
    perfectForm: 'hat geliebt',
    conjugation: {
      ich: 'liebe',
      du: 'liebst',
      er: 'liebt',
  ...
  'erklären': {
    ...
    gender: null,
    cefrLevel: 'A2',
    exampleSentence: 'Die Lehrerin erklärt die Aufgabe sehr geduldig.',
    verbType: 'regular',
    auxiliaryType: 'haben',
    presentForm: 'erklärt',
    simplePast: 'erklärte',
    perfectForm: 'hat erklärt',
    conjugation: {
      ich: 'erkläre',
      du: 'erklärst',
      er: 'erklärt',
